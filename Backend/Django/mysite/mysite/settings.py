...
SECRET_KEY = 'qh669ecdd6=_y0fau#gne79y8!-=zbk9n36o^2=fqpz1wrmj%t'
...
INSTALLED_APPS = [
    'PersonnelApp.apps.PersonnelappConfig',
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'presentationSite',  'static')
